      ...
      <div class="flex h-screen ">
        ...
        <div class="hidden lg:flex items-center justify-center flex-1 bg-white text-black">
          <div class="max-w-md text-center">
            <h1 className="text-7xl font-bold">Git Fit</h1>
            <h1 className="text-xl ">
              "Your Code, Regular Hit: Welcome to Git Fit!"
            </h1>
            <svg
        ...
        <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
          <div class="max-w-md w-full p-6">
            <h1 class="text-3xl font-semibold mb-6 text-black text-center my-[25px]">
              Sign Up
            </h1>
            <h1 class="text-sm font-semibold mb-6 text-gray-500 text-center">
              Connect with Our Community for Unlimited, Free Access!{" "}
            </h1>
            ...
            <form autoComplete="off" onSubmit={handleSignUp} class="space-y-4">
              <div>
                <label
                  for="username"
